...
DROP POLICY IF EXISTS "Anyone can view diet templates" ON public.diet_templates;
DROP POLICY IF EXISTS "Anyone can view diet meals" ON public.diet_meals;
DROP POLICY IF EXISTS "Anyone can view meal ingredients" ON public.meal_ingredients;
